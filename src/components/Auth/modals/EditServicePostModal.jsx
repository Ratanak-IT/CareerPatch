...
// ── Modern Dropdown (same style as SearchBar filter)
    ...
    <div ref={ref} className="relative w-full">
      ...
      <button
        ...
        className={`w-full flex items-center justify-between px-4 py-2.5
                   ...
                   ${disabled || loading ? "opacity-50 cursor-not-allowed" : "cursor-pointer hover:border-blue-400 dark:hover:border-blue-500 focus:ring-2 focus:ring-blue-400"}`}
      >
      ...
      {open && !loading && (
        <div
          className="absolute left-0 top-[calc(100%+8px)] z-50 w-full overflow-hidden
...
export default function EditServiceModal({ service, onClose }) {
  ...
  // Build category options for ModernDropdown
