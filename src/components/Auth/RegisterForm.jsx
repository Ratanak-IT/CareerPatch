...
import SignUpImage from "../../assets/login/signup.png";
import {
...
export default function RegisterForm() {
  ...
  const [registerFreelancer, { isLoading: lF }] =
    useRegisterFreelancerMutation();
  const [registerBusinessOwner, { isLoading: lB }] =
    useRegisterBusinessOwnerMutation();
  ...
  const { field, validate } = isBusiness ? businessForm : freelancerForm;
  ...
  const onSubmit = async (e) => {
    ...
    const resolvedPhone = rawPhone.startsWith("0")
  ...
  return (
    ...
    >
      <div
        className="relative flex w-full max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-4xl
      ...
      >
        ...
        >
          <button
            ...
            aria-label="Go back"
            className="absolute top-4 left-4 w-7 h-7 flex items-center justify-center rounded-full
                       bg-white/70 dark:bg-white/10 dark:backdrop-blur-sm
          ...
          <form onSubmit={onSubmit} noValidate className="w-full max-w-[340px]">
            ...
            <div className="flex flex-col items-center mb-4 md:hidden">
              <button
                ...
                onClick={() => window.history.back()}
                aria-label="Go back"
                className="self-start mb-3 w-7 h-7 flex items-center justify-center rounded-full
            ...
            {/* Role toggle */}
            <div
              className="flex items-center justify-center gap-5 mb-4 py-1.5 px-3 rounded-lg
            ...
            >
              <FormRadio
                ...
                label="Freelancer"
              />
              <div className="h-3 w-px bg-gray-200 dark:bg-white/15" />
              <FormRadio
                name="role"
                value="business"
                checked={isBusiness}
            ...
            <p className="text-center text-xs mt-2 text-gray-500 dark:text-slate-500">
