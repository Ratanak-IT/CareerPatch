      ...
      <div className="w-full max-w-300 mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="rounded-2xl overflow-hidden bg-white shadow-sm">
          ...
          <div className="flex items-center justify-between gap-4 px-4 sm:px-6 py-4">
            ...
            {!isOwner && (
              <button onClick={handleMessage} className="bg-blue-500 hover:bg-blue-600 text-white text-xs font-semibold px-4 py-2 rounded-lg flex items-center gap-1.5 shrink-0">
