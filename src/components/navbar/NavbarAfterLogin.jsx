...
const NOTIFICATIONS = [
  ...
  { id: 4, image: senghourImg,  title: "Payment received",         desc: "$320 has been added to your wallet",    time: "1d ago",  read: true  },
];
          ...
          <div ref={notifRef} style={{ position: "relative" }}>
            ...
            {notifOpen && (
              <div style={{ ...dropdownStyle, width: "360px" }}>
                ...
                >
                  <span style={{ fontFamily: "'Poppins', sans-serif", fontSize: "15px", fontWeight: 600, color: darkMode ? "#f1f5f9" : "#0f172a" }}>
                    Notifications
                    {unreadCount > 0 && (
                      <span
                  ...
                  {unreadCount > 0 && (
                    <button
                      onClick={markAllRead}
                      style={{ fontFamily: "'Poppins', sans-serif", fontSize: "12px", color: "#3b82f6", background: "none", border: "none", cursor: "pointer", fontWeight: 500 }}
                    >
                      Mark all read
                    </button>
                  )}
                  ...
                  {notifications.map((n) => (
                    <div
                      ...
                      style={{
                        background: n.read
                          ? "transparent"
                          : darkMode ? "rgba(59,130,246,0.08)" : "rgba(239,246,255,0.8)",
...
>
  ...
  />
                      ...
                      <div className="flex-1 min-w-0">
                        <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: "13.5px", fontWeight: n.read ? 400 : 600, color: darkMode ? "#e2e8f0" : "#0f172a", margin: "0 0 2px 0" }}>
                          {n.title}
                        </p>
                        <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: "12px", color: darkMode ? "#94a3b8" : "#64748b", margin: "0 0 4px 0" }}>
                          {n.desc}
                        </p>
                        <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: "11px", color: "#3b82f6", margin: 0 }}>
                          {n.time}
                        </p>
                      </div>
                      {/* Unread dot */}
                ...
                >
                  <Link
                    ...
                    style={{ fontFamily: "'Poppins', sans-serif", fontSize: "13px", color: "#3b82f6", textDecoration: "none", fontWeight: 500 }}
                  >
          ...
          <div ref={profileRef} style={{ position: "relative" }}>
            ...
            >
              ...
              <svg
                ...
                stroke={darkMode ? "#94a3b8" : "#64748b"} strokeWidth="2.5" strokeLinecap="round"
            ...
            {profileOpen && (
              <div style={{ ...dropdownStyle, width: "240px" }}>
                ...
                >
                  ...
                  />
                  <div>
                    <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: "14px", fontWeight: 600, color: darkMode ? "#f1f5f9" : "#0f172a", margin: 0 }}>
                      Bidin
                    </p>
                    <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: "12px", color: darkMode ? "#64748b" : "#94a3b8", margin: 0 }}>
                      Freelancer
                    </p>
                  </div>
                </div>
                ...
                {[
                  ...
                  >
                    ...
                    <span style={{ fontFamily: "'Poppins', sans-serif", fontSize: "14px", fontWeight: 500 }}>{item.label}</span>
                  </Link>
                ))}

                {/* Logout */}
                <div style={{ borderTop: `1px solid ${darkMode ? "#334155" : "#f1f5f9"}`, padding: "8px 0" }}>
                  <button
                    onClick={() => { setProfileOpen(false); /* call logout here */ }}
                    ...
                    style={{ color: "#ef4444" }}
                    onMouseEnter={e => e.currentTarget.style.background = darkMode ? "rgba(239,68,68,0.08)" : "rgba(254,242,242,0.8)"}
                    onMouseLeave={e => e.currentTarget.style.background = "transparent"}
                  >
                    <span style={{ fontSize: "16px" }}>🚪</span>
                    <span style={{ fontFamily: "'Poppins', sans-serif", fontSize: "14px", fontWeight: 500 }}>Log out</span>
                  </button>
                </div>
              </div>
            )}
        ...
        {/* ── MOBILE: dark toggle + notification + hamburger ── */}
        <div className="lg:hidden flex items-center gap-2">
          <button onClick={toggleDark} className="w-9 h-9 flex items-center justify-center text-blue-500 bg-transparent border-0 cursor-pointer">
      ...
      {mobileOpen && (
        <div
          ...
          style={{ background: darkMode ? "#0f172a" : "#ffffff", borderColor: darkMode ? "#1e293b" : "#f1f5f9" }}
        >
          ...
          <div className="flex items-center gap-3 px-4 sm:px-8 py-4"
            ...
            <img src={profileImg} alt="Profile" className="rounded-full object-cover flex-shrink-0"
                 style={{ width: "44px", height: "44px", border: "2px solid #3b82f6" }} />
            <div>
              <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: "15px", fontWeight: 600, color: darkMode ? "#f1f5f9" : "#0f172a", margin: 0 }}>Bidin</p>
              <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: "12px", color: "#3b82f6", margin: 0 }}>Freelancer</p>
            </div>
            <button
              style={{ marginLeft: "auto", fontFamily: "'Poppins', sans-serif", fontSize: "13px", color: "#ef4444", background: "none", border: "none", cursor: "pointer", fontWeight: 500 }}
            >
              Log out
            </button>
          </div>
