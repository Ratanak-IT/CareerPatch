      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-[120px] flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-0 min-h-[calc(100vh-89px)]">
        ...
        <div className="w-full lg:w-[48%] space-y-7 py-16 lg:py-20">
          ...
          <div className="flex items-center gap-2.5 w-fit px-4 py-2 rounded-full bg-[#1E88E5]/10 border border-[#1E88E5]/25">
            <div
              className="flex items-center rounded-full px-0.5 bg-[#1E88E5]"
              style={{ width: "32px", height: "18px" }}
            >
              <div
                className="rounded-full bg-white ml-auto"
          ...
          {/* Description */}
          <p className="text-sm md:text-base leading-relaxed max-w-[480px] m-0 text-gray-400 dark:text-slate-400">
            ...
            <div className="flex -space-x-3">
              {[avatar1, avatar2, avatar3].map((src, i) => (
                <img
                  ...
                  src={src}
                  alt="freelancer"
                  className="w-10 h-10 rounded-full object-cover border-2 border-white dark:border-[#0f172a]"
                />
              ))}
            </div>

            <p className="text-[12px] leading-snug m-0 text-gray-400 dark:text-slate-400">
              Over <span className="text-[#1E88E5] font-bold">12800+</span>{" "}
              freelancers to
              <br />
        ...
        <div className="w-full lg:w-[52%] relative flex justify-center lg:justify-end items-end self-end">
          ...
          <div
            className={[
              "absolute z-20 rounded-2xl p-5 flex flex-col gap-1.5 min-w-[150px]",
          ...
          >
            <div className="flex items-center gap-2">
              <span className="text-[22px] font-extrabold leading-none text-gray-900 dark:text-slate-100">
                30K+
              </span>
              <span className="text-xl">💼</span>
            </div>
            <span className="text-[13px] font-medium text-gray-400 dark:text-slate-400">
              People got hired
            </span>
          </div>
