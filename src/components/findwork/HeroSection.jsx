    ...
    >
      ...
      >
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-6 lg:px-[120px]">
          ...
          >
            <div
              className="w-full lg:w-[52%] flex flex-col gap-5
            ...
            >
              ...
              >
                ...
                <br />
                That Match Your <span className="text-[#1E88E5]">Skills</span>
              </h1>

              <p
                className="text-sm md:text-base leading-relaxed max-w-[480px] m-0
                           text-gray-500 dark:text-slate-400"
              >
                Browse thousands of freelance opportunities tailored to your
