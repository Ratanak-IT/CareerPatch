export function FreelancerCardSkeleton() {
  return (
    ...
    >
      {/* ── Image placeholder ── */}
      <div
        className="relative shrink-0 bg-gray-200 dark:bg-slate-700 animate-pulse"
        style={{ height: "clamp(140px, 20vw, 230px)" }}
      />

      {/* ── Body ── */}
      <div className="p-3 sm:p-4 flex flex-col flex-1 gap-0">
        ...
        {/* Tags + Date */}
        <div className="flex items-center justify-between mb-3 sm:mb-4 flex-wrap gap-y-1.5">
          <div className="flex gap-1">
            <div className="h-4 sm:h-5 w-14 sm:w-16 rounded-full bg-gray-200 dark:bg-slate-700 animate-pulse" />
            <div className="h-4 sm:h-5 w-12 sm:w-14 rounded-full bg-gray-200 dark:bg-slate-700 animate-pulse" />
          </div>
          <div className="h-2.5 sm:h-3 w-14 sm:w-16 rounded-full bg-gray-200 dark:bg-slate-700 animate-pulse" />
        </div>
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-gray-200 dark:bg-slate-700 animate-pulse" />
        </div>
