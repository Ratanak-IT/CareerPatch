...
export function TeamCardSkeleton() {
  return (
    <div className="h-full rounded-2xl border bg-white border-slate-200
      ...
      <div className="mx-auto h-32 w-32 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse" />
      <div className="mx-auto mt-5 h-4 w-32 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse" />
      <div className="mx-auto mt-2 h-3 w-24 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse" />
      <div className="mt-4 flex items-center justify-center gap-2">
        <div className="h-5 w-5 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse" />
        <div className="h-5 w-5 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse" />
        <div className="h-5 w-5 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse" />
      </div>
      <div className="mx-auto mt-4 h-px w-4/5 bg-slate-200 dark:bg-slate-700" />
      <div className="mx-auto mt-3 h-3 w-28 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse" />
    </div>
  );
}
...
export default function TeamCard({ img, name, role, badge, socials }) {
  return (
    <div className="h-full rounded-2xl border
      ...
      <div className="mt-5 text-lg font-semibold text-slate-900 dark:text-white">{name}</div>
      <div className="mt-1 text-sm text-slate-500 dark:text-slate-400">{role}</div>
