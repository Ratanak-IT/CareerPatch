  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <button
          onClick={() => navigate(-1)}
          className="inline-flex items-center gap-2 text-sm font-medium mb-4 sm:mb-7 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl transition-all
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="w-full lg:w-[62%] flex flex-col gap-5 order-1">
            ...
            {/* ── Description ── */}
            <div className={card}>
              <h2 className="text-base sm:text-[20px] font-bold mb-2 sm:mb-3 text-slate-900 dark:text-white">
                Description
              </h2>
              <p className="text-sm sm:text-[16px] leading-[1.75] whitespace-pre-line text-slate-500 dark:text-gray-200">
                {desc}
              </p>
            </div>
            ...
            {user?.bio && (
              <div className={card}>
                ...
                <p className="text-[16px] leading-[1.75] text-slate-500 dark:text-gray-200">
                  {user.bio}
                </p>
              </div>
            )}
