// E) src/pages/ProfileFreelancer.jsx  (FULL UPDATED VERSION - keeps your layout)
...
export default function ProfileFreelancerPage() {
  ...
  } = useGetMyServicesQuery(undefined, { skip: !isAuthed });
  ...
  // Bookmarks (only when authed)
const { data: serviceBookmarksRaw } = useGetServiceBookmarksQuery(undefined, { skip: !isAuthed });
const { data: jobBookmarksRaw } = useGetJobBookmarksQuery(undefined, { skip: !isAuthed });
...
const jobBookmarks = useMemo(() => pickArray(jobBookmarksRaw), [jobBookmarksRaw]);
  ...
  // Merge createdAt into own services
  ...
  }, [myServices, createdAtMap, categoryMap]);
            ...
            <div className="mt-4">
              ...
              {!servicesLoading && !servicesError && servicesForCards.length === 0 && (
                <div className="flex flex-col items-center justify-center py-16 text-gray-400">
                  ...
                  <p className="text-xs mt-1">Click the Post button to create your first service</p>
                </div>
              )}
